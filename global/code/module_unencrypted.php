...
function form_builder__install($module_id)
{
  ...
  if (empty($encrypted_key) || empty($module_key) || $encrypted_key != crypt($module_key, "az"))
  {
    $success = false;
  }
  else
  {
    $success = true;
    $queries = array();
    $table1 = $g_table_prefix . "module_form_builder_forms";
    $queries[] = "
      CREATE TABLE $table1 (
    ...
    $table2 = $g_table_prefix . "module_form_builder_form_placeholders";
    $queries[] = "
      CREATE TABLE $table2 (
    ...
    $table3 = $g_table_prefix . "module_form_builder_form_templates";
    $queries[] = "
      CREATE TABLE $table3 (
        published_form_id mediumint(9) NOT NULL,
    ...
    $table4 = $g_table_prefix . "module_form_builder_templates";
    $queries[] = "
      CREATE TABLE $table4 (
    ...
    $table5 = $g_table_prefix . "module_form_builder_template_sets";
    $queries[] = "
      CREATE TABLE $table5 (
...
function fb_delete_tables()
{
  ...
  $table4 = $g_table_prefix . "module_form_builder_templates";
  @mysql_query("DROP TABLE $table4");

  $table5 = $g_table_prefix . "module_form_builder_template_sets";
  @mysql_query("DROP TABLE $table5");
