...
$(function () {
  ...
  $("#major_error span.close").bind("click", function () {
    window.close();
  });
  ...
  $(".save_btn").bind("click", function () {
    builder_js.save_settings("save_button");
  });
  ...
  $("#thankyou_page_edit_full_screen").bind("click", function () {
    builder_js.full_screen_editor("thankyou_page");
  });
  $("#form_offline_page_edit_full_screen").bind("click", function () {
    builder_js.full_screen_editor("form_offline_page");
  });
  ...
  $("#fod_icon_id").bind("click", function () {
    $.datepicker._showDatepicker($("#fod")[0]);
  });

  $("#clear_offline_form").bind("click", function () {
    $("#fod").val("");
    $(this).fadeOut(200);
  });
});
...
builder_js.page_loaded = function () {
  ...
  iframe_doc.find("form").removeAttr("action").bind("submit", function () {
    return false;
  });
  iframe_doc.find("a").bind("click", function () {
    return false;
  });
}
    ...
    $.ajax({
      ...
      success: function (html) {
        ...
        ft.queue.push([
          ...
          function () {
            return ($("#templates_loaded").length > 0);
          }
        ]);
        ft.process_queue();
      }
    ...
    $.ajax({
      ...
      success: function (html) {
        ...
        ft.queue.push([
          ...
          function () {
            return ($("#placeholders_loaded").length > 0);
          }
        ]);
        ft.process_queue();
      }
