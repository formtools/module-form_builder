            ...
            <select name="page_layout_template_id" id="page_layout_template_id" class="full">
                {foreach from=$grouped_templates.page_layout item=template name=row}
                    <option value="{$template.template_id}"
                            {if $selected_templates.page_layout == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
        ...
        <div>
            <select name="footer_template_id" id="footer_template_id" class="full">
                {foreach from=$grouped_templates.footer item=template name=row}
                    <option value="{$template.template_id}"
                            {if $selected_templates.footer == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
        ...
        <div>
            <select name="form_page_template_id" id="form_page_template_id" class="full">
                {foreach from=$grouped_templates.form_page item=template name=row}
                    <option value="{$template.template_id}"
                            {if $selected_templates.form_page == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
        ...
        <div>
            <select name="review_page_template_id" id="review_page_template_id" class="full">
                {foreach from=$grouped_templates.review_page item=template name=row}
                    <option value="{$template.template_id}"
                            {if $selected_templates.review_page == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
        ...
        <div>
            <select name="thankyou_page_template_id" id="thankyou_page_template_id" class="full">
                {foreach from=$grouped_templates.thankyou_page item=template name=row}
                    <option value="{$template.template_id}"
                            {if $selected_templates.thankyou_page == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
        ...
        <div>
            <select name="form_offline_page_template_id" id="form_offline_page_template_id" class="full">
                {foreach from=$grouped_templates.form_offline_page item=template name=row}
                    <option value="{$template.template_id}"
                            {if $selected_templates.form_offline_page == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
{else}
    <input type="hidden" name="form_offline_page_template_id"
           value="{$grouped_templates.form_offline_page.0.template_id}"/>
{/if}
        ...
        <div>
            <select name="navigation_template_id" id="navigation_template_id" class="full">
                {foreach from=$grouped_templates.navigation item=template name=row}
                    <option value="{$template.template_id}"
                            {if !empty($selected_templates) && $selected_templates.navigation == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
        ...
        <div>
            <select name="error_message_template_id" id="error_message_template_id" class="full">
                {foreach from=$grouped_templates.error_message item=template name=row}
                    <option value="{$template.template_id}"
                            {if $selected_templates.error_message == $template.template_id}selected="selected"{/if}>{$template.template_name}</option>
                {/foreach}
            </select>
        </div>
    </div>
