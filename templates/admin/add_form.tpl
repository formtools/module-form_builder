...
<table cellpadding="0" cellspacing="0">
    <tr>
        <td width="45"><a href="../"><img src="{$images_url}/icon_forms.gif" border="0" width="34" height="34"/></a>
        </td>
        <td class="title">
            <a href="{$g_root_url}/admin/forms/">{$LANG.word_forms}</a> <span class="joiner">&raquo;</span>
            <a href="{$g_root_url}/admin/forms/add/">{$LANG.phrase_add_form}</a> <span class="joiner">&raquo;</span>
            {$L.module_name}
        </td>
    </tr>
</table>
    ...
    <table cellspacing="1" cellpadding="0" class="list_table">
        ...
        <tr>
            ...
            <td>
                ...
                <div class="hint">
                    {$L.text_add_form_num_fields_hint}
                </div>
            </td>
        </tr>
        <tr>
                ...
                <table cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        <td>
                            ...
                            <label for="at2">{$LANG.word_public} <span
                                        class="light_grey">{$LANG.phrase_all_clients_have_access}</span></label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="radio" name="access_type" id="at3" value="private"/>
                            <label for="at3">{$LANG.word_private} <span
                                        class="light_grey">{$LANG.phrase_only_specific_clients_have_access}</span></label>
                        </td>
                    </tr>
                </table>
