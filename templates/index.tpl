                            ...
                            <div class="row_group{if $smarty.foreach.row.last} rowN{/if}">
                                ...
                                <ul>
                                    ...
                                    <li class="col5 check_area"><a
                                                href="template_sets/index.php?page=templates&set_id={$set_id}">{$template_set.templates|@count}</a>
                                    </li>
                                    <li class="col6 check_area"><a
                                                href="template_sets/index.php?page=resources&set_id={$set_id}">{$template_set.resources|@count}</a>
                                    </li>
                                    <li class="col7 check_area"><a
                                                href="template_sets/index.php?page=placeholders&set_id={$set_id}">{$template_set.placeholders|@count}</a>
                                    </li>
                                    <li class="col8 edit"><a
                                                href="template_sets/index.php?page=info&set_id={$set_id}"></a></li>
