...
<form method="post" action="{$same_page}">
    <table cellspacing="0" cellpadding="1" class="list_table margin_bottom_large">
        <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td><input type="text" name="default_published_folder_path" id="default_published_folder_path"
                                   style="width: 99%" value="{$module_settings.default_published_folder_path|escape}"/>
                        </td>
                        <td width="170">
                            <input type="button" value="{$LANG.phrase_test_folder_permissions}"
                                   onclick="ft.test_folder_permissions($('#default_published_folder_path').val(), 'permissions_result')"
                                   style="width: 170px;"/>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td><input type="text" name="default_published_folder_url" id="default_published_folder_url"
                                   style="width: 99%" value="{$module_settings.default_published_folder_url|escape}"/>
                        </td>
                        {if $allow_url_fopen}
                            <td width="170"><input type="button" value="{$LANG.phrase_confirm_folder_url_match}"
                                                   onclick="ft.test_folder_url_match($('#default_published_folder_path').val(), $('#default_published_folder_url').val(), 'folder_match_message_id')"
    ...
    <table cellspacing="0" cellpadding="1" class="list_table">
        <tr>
            ...
            <td>
                <input type="text" name="review_page_title" id="review_page_title" style="width: 99%"
                       value="{$module_settings.review_page_title|escape}"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="thankyou_page_title" id="thankyou_page_title" style="width: 99%"
                       value="{$module_settings.thankyou_page_title|escape}"/>
            ...
            <td class="pad_left_small">
                <table cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td><input type="text" name="form_builder_width" id="width" size="4"
                                   value="{$module_settings.form_builder_width}"/>px
                        </td>
                    </tr>
                    <tr>
                        <td class="medium_grey"><label for="height">{$L.word_height}</label></td>
                        <td><input type="text" name="form_builder_height" id="height" size="4"
                                   value="{$module_settings.form_builder_height}"/>px
                        </td>
                    </tr>
                </table>
            </td>
